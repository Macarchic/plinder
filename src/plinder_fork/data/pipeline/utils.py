...
from plinder_fork.core.scores import query_clusters
from plinder_fork.core.utils import schemas
from plinder_fork.core.utils.log import setup_logger
from plinder_fork.core.utils.unpack import expand_config_context
from plinder_fork.data.utils import tanimoto
from plinder_fork.data.utils.annotations.aggregate_annotations import Entry

if TYPE_CHECKING:
    from plinder_fork.data.utils.annotations.get_similarity_scores import Scorer
...
def apo_file_from_link_id(
    ...
    from plinder_fork.data.utils.annotations.save_utils import save_cif_file
